...
fn generate_sample_dlt_file() {
    ...
    let messages = vec![
        ("ECU1", "SYS", "BOOT", 4, "System boot completed successfully."),
        ("ECU1", "NAV", "GPS", 4, "GPS signal acquired: lat=35.6812, lon=139.7671"),
        ("ECU1", "NAV", "MAP", 5, "Loading map tile for region Tokyo-Central"),
        ("ECU1", "DIAG", "CAN", 3, "CAN bus timeout on interface vcan0"),
        ("ECU1", "SYS", "MEM", 2, "Memory usage critical: 95% of 4GB used"),
        ("ECU1", "NAV", "GPS", 4, "Position update: speed=60km/h, heading=NNE"),
        ("ECU1", "DIAG", "OBD", 4, "OBD-II PID query: engine RPM = 2400"),
        ("ECU1", "DIAG", "CAN", 3, "CAN frame drop detected: message_id=0x1A3"),
        ("ECU1", "SYS", "NET", 4, "WiFi connected to SSID: VehicleNet_5G"),
        ("ECU1", "APP", "HMI", 5, "User pressed button: HOME (debug trace)"),
        ("ECU1", "SYS", "BOOT", 1, "FATAL: Watchdog timer expired! Resetting ECU..."),
        ("ECU1", "NAV", "GPS", 4, "Satellite count: 12, HDOP: 0.9"),
        ("ECU1", "DIAG", "OBD", 4, "Coolant temperature: 92°C (normal range)"),
        ("ECU1", "APP", "HMI", 6, "Verbose: rendering frame #12847, delta=16ms"),
        ("ECU1", "SYS", "MEM", 3, "Heap fragmentation warning: 23% fragmented"),
        ("ECU2", "COM", "ETH", 4, "Ethernet link up on eth0: 100Mbps Full-Duplex"),
        ("ECU2", "COM", "ETH", 2, "Ethernet CRC error count exceeded threshold"),
        ("ECU2", "SEC", "AUTH", 4, "Certificate validation passed for service XYZ"),
        ("ECU2", "SEC", "AUTH", 2, "Authentication failed: invalid token from client 10.0.0.5"),
        ("ECU2", "COM", "DOIP", 4, "DoIP connection established with tester 10.0.0.99"),
    ];
